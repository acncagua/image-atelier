...
export function recoverDraft(saved,defaults){
 ...
 for(const [key,allowed] of Object.entries({mode:['generate','polish','inpaint','upscale'],provider:['mock','openai','qwen'],model:['gpt-image-2.5-sunburst','gpt-image-2.5-flare','Qwen-Image-2.1'],quality:['low','medium','high','xhigh','max','auto'],format:['png','jpeg','webp']})){
