...
export default function LocalHistory({edits,onResult,onEdit,embedded=false}){
 return <section className={embedded?'history-content':'history'}>{embedded?null:<h2>ローカル編集の履歴 <small>無料・API予算には加算しません</small></h2>}
